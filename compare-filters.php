...
<div id="indicator-filter-wrapper" class="container-sort">
    <div class="row compare-controls-nav">
        <div class="col-md-5"><a id="reset-filters" class="btn btn-default" href="/urbannumbers/compare-cities/">RESET FILTERS</a>
...
<div id="indicator-filter-wrapper" class="container-sort sort-location">
    <div class="row">
