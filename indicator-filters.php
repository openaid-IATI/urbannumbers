<div class="container-sort" id="indicator-filter-wrapper">
		<div class="sort-holder">
			...
			<ul class="sort-list">
				...
				<li>
					<a name="countries" class="opener filter-open" href="#">COUNTRY <span class="caret"></span></a>
					<div class="slide">
				...
				<li>
					<a name="cities" class="opener filter-open" href="#">CITY <span class="caret"></span></a>
					<div class="slide">
