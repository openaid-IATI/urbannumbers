...
<link rel="shortcut icon" href="/favicon.ico" type="image/x-icon"/>
    ...
    <script type="text/javascript" src="<?php echo get_template_directory_uri(); ?>/fonts/jsfonts.js"></script>
    <?php wp_head(); ?>
                ...
                <div class="container">
                    ...
                    <div class="btn-group add-nav">
                        ...
                        <ul class="dropdown-menu" role="menu">
                            ...
                            <li><a href="<?php echo home_url() . "/my-dashboard/#my-infographics"; ?>"><span class="img-wrap"><i class="glyphicon glyphicon-stats"></i></span>My data reports</a></li>
                            <li><a href="<?php echo home_url() . "/build-data-report/"; ?>"><span class="img-wrap"><i class="glyphicon glyphicon-plus-sign"></i></span>Create new data report</a></li>
